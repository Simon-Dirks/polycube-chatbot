...
@NgModule({
  imports: [CommonModule, IonicModule, RouterModule, SidebarModule.forRoot()],
  exports: [CubeComponent],
  declarations: [CubeComponent, TimeSliderComponent, ForceDirectedComponent],
  providers: [
    GoogleDriveProvider,
    LocalFileLoaderService,
