...
export class GUI {
  ...
  createDATGUI(): void {
    ...
    pCubeFolder
      .add(pCubeParams, "time", ["aggregated", "absolute"])
      .onChange(() => {
        this.pCubeConfigEmitter.emit("change", {
    ...
    pCubeFolder
      .add(pCubeParams, "nodeColor", ["categorical", "temporal", "monochrome"])
      .onChange(() => {
        this.pCubeConfigEmitter.emit("change", {
      ...
      .name("Point Color");
    pCubeFolder
      .add(pCubeParams, "dataSet", ["Cushman", "Alliances", "?"])
      .onChange(() => {
        this.pCubeConfigEmitter.emit("change", {
